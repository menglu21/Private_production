...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:SMP-RunIISummer20UL18HLT-00455.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--era nevts:3481'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL18RECO-00455.root'),
