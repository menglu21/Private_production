...
1. For powheg gridpack, the pdf reweight is super time consuming, which will excess allowed maximum time in crab
2. untar the powheg gridpack, in pwg-rwl.dat, remove all the pdf weights, eg. only keep the scale variations, then tar the gridpack again
<initrwgt>
