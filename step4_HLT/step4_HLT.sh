...
cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/SMP-RunIISummer20UL18HLT-00455/
...
# Dump actual test code to a SMP-RunIISummer20UL18HLT-00455_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > SMP-RunIISummer20UL18HLT-00455_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --era Run2_2018 --customise Configuration/DataProcessing/Utils.addMonitoring --step HLT:2018v32 --geometry DB:Extended --conditions 102X_upgrade2018_realistic_v15 --customise_commands 'process.source.bypassVersionCheck = cms.untracked.bool(True)' --datatier GEN-SIM-RAW --eventcontent RAWSIM --python_filename SMP-RunIISummer20UL18HLT-00455_1_cfg.py --fileout file:SMP-RunIISummer20UL18HLT-00455.root --filein file:SMP-RunIISummer20UL18DIGIPremix-00451.root --no_exec --mc -n $EVENTS || exit $? ;

# End of SMP-RunIISummer20UL18HLT-00455_test.sh file
EndOfTestFile

# Make file executable
chmod +x SMP-RunIISummer20UL18HLT-00455_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/SMP-RunIISummer20UL18HLT-00455_test.sh)
