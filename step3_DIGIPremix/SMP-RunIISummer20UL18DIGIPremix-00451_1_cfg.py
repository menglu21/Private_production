...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(2913)
)

# Input source
process.source = cms.Source("PoolSource",
    dropDescendantsOfDroppedBranches = cms.untracked.bool(False),
    fileNames = cms.untracked.vstring('file:SMP-RunIISummer20UL18SIM-00455.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--era nevts:2913'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL18DIGIPremix-00451.root'),
...
# Other statements
process.mixData.input.fileNames = cms.untracked.vstring(['/store/mc/RunIISummer20ULPrePremix/Neutrino_E-10_gun/PREMIX/UL18_106X_upgrade2018_realistic_v11_L1v1-v2/240010/54D3B0BE-6D47-E54E-A6A5-5F626E055BF0.root'])
